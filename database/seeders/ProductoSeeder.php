...
class ProductoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('productos')->insert([
            ...
            'cargo' => "Gerente Compliance y Regulatorio",
        ...
        DB::table('productos')->insert([
            ...
            'cargo' => "Gerente Laboral y Migratorio",
        ...
        DB::table('productos')->insert([
            ...
            'cargo' => "Jefa de Relaciones Sociales y Gubernamentales",
