...
use App\Models\BannerPublicacion;

class BannerPublicacionController extends Controller
{
   private $urlAssets;
    ...
    public function __construct()
    {
        ...
        $this->urlAssets = 'assets/imagen/banner/publicacion';
        $this->urlAssetsProd = config('myconfig.url_upload_banner_publicacion');
        /* $this->urlAssetsProd = '/home1/iatecdigital/back.iatecdigital.com/assets/imagen/banner'; */
    }

    public function index(){
        $banner_publicacion=BannerPublicacion::all();
        return response()->json($banner_publicacion,Response::HTTP_OK);
    }
...
{
    $id = $request->input('id_banner_publicacion');
    $post = BannerPublicacion::find($id);
 ...
 public function destroy($category){
        $category=BannerPublicacion::find($category);
